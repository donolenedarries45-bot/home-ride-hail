  ...
  return (
    <div className="fixed inset-0 overflow-hidden bg-background">
      ...
      <div className="absolute top-0 left-0 right-0 z-30 flex items-center justify-between gap-3 p-4 pointer-events-none">
        ...
        <div className="pointer-events-auto flex items-center gap-2 bg-gradient-to-r from-primary to-pulse text-primary-foreground border border-primary/40 shadow-elevated px-4 py-2 rounded-full animate-pulse">
